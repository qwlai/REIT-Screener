...
class YahooCrawler():
    ...
    def set_reit_info(self, dict_of_reits):
        for reit in dict_of_reits:
            ...
            self.set_price_changes(reit, ticker, dict_of_reits)
            self.set_dividend_yield_ttm(reit, dict_of_reits)
            self.set_stock_distribution(reit, ticker, dict_of_reits)
            
    def set_price_changes(self, reit, ticker, dict_of_reits):
    ...
    def set_dividend_yield_ttm(self, reit, dict_of_reits):
    ...
    def set_stock_distribution(self, reit, ticker, dict_of_reits):
        ...
        dict_of_reits[reit]['institutional_holders'] = top_5_institutional_holders
        dict_of_reits[reit]['insiders_held_percentage'] = ticker.major_holders[reit]['insidersPercentHeld']
        dict_of_reits[reit]['institutional_held_percentage'] = ticker.major_holders[reit]['institutionsPercentHeld']
